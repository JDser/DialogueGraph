...
public class TEST_DialogueThread
{
    public event Action OnThreadEnd;


    public TEST_DialogueManager Manager { get; set; }
    ...
    public TEST_DialogueThread(TEST_DialogueManager manager, DialogueAsset asset)
    {
    ...
    public void OnTick()
    {
        ...
        if (m_currentProperty == null && CurrentNode.Properties.Length > 0)
        {
            ...
            Debug.Log("set currentProperty thread this");
